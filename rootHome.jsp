...
<style>
  ...
  <div class="grid-container">
    ...
    <div class="main">
      <p style="font-size:15px;color:white;">You are connected to the Project 4 Enterprise System database as a <mark>root-level</mark> user.<br>Please enter any valid SQL query or update command in the box below</p>
      <form action = "rootUserApp" method = "post"><!-- the action will be the path to our java .class via .xml -->
